...
import { getAccessCookieName, getAccessTokenMaxAgeSeconds, getRefreshCookieName, getRefreshTokenMaxAgeSeconds, getSessionCookieName, getSessionMaxAgeSeconds } from "@fulbito/server-core/session";
function isProduction() {
    return process.env.NODE_ENV === "production";
}
export function authCookieHeaders(input) {
    return [
        serializeCookie({
