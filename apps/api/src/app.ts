...
import * as groupsSearchRoute from "./routes/groups/search/route";
...
import * as adminCronMatchReminderRoute from "./routes/admin/cron/match-reminder/route";
...
import * as notificationsInboxNotificationIdRoute from "./routes/notifications/inbox/[notificationId]/route";
...
registerRoute("/api/groups/search", groupsSearchRoute);
...
registerRoute("/api/notifications/inbox/:notificationId", notificationsInboxNotificationIdRoute);
...
registerRoute("/api/admin/cron/match-reminder", adminCronMatchReminderRoute);
