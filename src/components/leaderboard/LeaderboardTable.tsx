...
export function LeaderboardTable({
  ...
  return (
    <section className={`flex flex-col gap-2.5 transition-opacity ${loading ? "opacity-70" : "opacity-100"}`}>
      ...
      <div className="h-[488px] overflow-hidden rounded-[6px] border border-[#2a2a2e] bg-[var(--bg-body)] p-[15px_10px]">
        <div className="flex items-center justify-between px-[2px] pb-[2px]">
          ...
          <div className="flex w-[188px] gap-3">
            ...
            <span className="w-20 text-center font-mono text-[10px] font-semibold text-[var(--text-muted)]">EX/RE/NA</span>
      ...
      <p className="px-[2px] pt-[2px] text-[10px] font-medium text-[var(--text-muted)]">EX: exacto  RE: resultado  NA: sin acierto</p>
    </section>
  );
}
